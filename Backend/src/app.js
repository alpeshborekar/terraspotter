...
app.get('/health', async (req, res) => {
  ...
  } catch { checks.services.database = 'error'; checks.status = 'degraded' }
  ...
  } catch { checks.services.ml = 'unavailable' }
...
app.use('/api/plantations', require('./routes/plantation.routes'))
